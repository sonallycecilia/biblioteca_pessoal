...
public class Livro extends Texto {
    ...
    public Livro(String nomeTexto, ArrayList<String> nomeAutores, String dataPublicacao, String inicioLeitura, String terminoLeitura, int numPaginas, StatusTexto status, String nomeEditora, int numEdicao, String nomeGenero) {
    ...
    public Livro(String nomeTexto, ArrayList<String> nomeAutores, String dataPublicacao, int numPaginas, StatusTexto status, String nomeEditora, int numEdicao, String nomeGenero) {
    ...
    public Livro(String nomeTexto, ArrayList<String> nomeAutores, String dataPublicacao, String inicioLeitura, int numPaginas, StatusTexto status, String nomeEditora, int numEdicao, String nomeGenero) {
